	...
	<tr class="mdemoFormRow">
		<td>
			<a href="/Cal/prevYear?month={$month}&year={$year}"
				title="Previous Year"><img src="/images/arrowLeft.png" border="0"><img src="/images/arrowLeft.png" border="0"></a>
		</td>
		<td>
			<a href="/Cal/prevMonth?month={$month}&year={$year}"
				title="Previous Month"><img src="/images/arrowLeft.png" border="0"></a>
		</td>
		<td width="10"></td>
		<td>
		...
		<td>
			<a href="/Cal/nextMonth?month={$month}&year={$year}"
				title="Next Month"><img src="/images/arrowRight.png" border="0"></a>
		</td>
		<td>
			<a href="/Cal/nextYear?month={$month}&year={$year}"
				title="Next Year"><img src="/images/arrowRight.png" border="0"><img src="/images/arrowRight.png" border="0"></a>
		</td>
	</tr>
</table>
</form>
